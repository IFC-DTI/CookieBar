/**
 * Original: https://www.gov.br/portal_javascripts/++resource++lgpd.plugin/block_cookies.js?original=1
 */
...
function getCookie (name) {
    ...
    // console.log('getCookie: ', parts.pop());
    return parts.length < 2 ? undefined : parts.pop().split(";").shift();
}

function setCookie (name, value, expiryDays, domain, path, secure, samesite) {
    //console.log("setCokkie", name, value, expiryDays, domain, path, secure, samesite);
    var exdate = new Date();
